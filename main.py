...
BOT_TOKEN = (os.getenv("8545376566:AAFm2315W462Z-M2pdi9Ys6oS08P-xQQQKU") or "").strip()
BOT_USERNAME = (os.getenv("MemorGarant_robot") or "").strip()  # без "@"
OWNER_ID = int((os.getenv("7288805373") or "0").strip() or "0")

SUPPORT_USERNAME = "but_alright"  # техподдержка: @but_alright

if not BOT_TOKEN:
    raise RuntimeError("Missing 8545376566:AAFm2315W462Z-M2pdi9Ys6oS08P-xQQQKU in .env")
if not BOT_USERNAME:
    raise RuntimeError("Missing MemorGarant_robot in .env (without @)")
if OWNER_ID <= 0:
    raise RuntimeError("Missing/invalid 7288805373 in .env")
